...
Generated by Kazikit CV Roaster with Vercel AI SDK 🇰🇪
...
`
    ...
    a.href = url
    a.download = `cv-roast-ai-sdk-${roastTone}-${Date.now()}.txt`
    a.click()
  ...
  const handleShare = async () => {
    ...
    const shareData = {
      ...
      text: `I just got my resume analyzed by Kazikit's AI CV Roaster with Vercel AI SDK${score ? ` - scored ${score}/100 for Kenya job market readiness!` : ""} Made in Kenya for African job seekers 🇰🇪`,
                ...
                <div className="lg:col-span-2">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600">
                      Get AI-powered feedback with real-time streaming analysis for Kenya and beyond! 🇰🇪
                    </p>
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-white/60 rounded-lg border border-blue-100">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-600">See results as they're generated (recommended)</p>
                      </div>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center pt-6 border-t border-gray-200">
                  ...
                  <p className="text-xs text-emerald-600 font-medium">
                    Powered by Vercel AI SDK • Helping you succeed in your career journey! 🚀🇰🇪
                  </p>
                </div>
              </div>
            )}
